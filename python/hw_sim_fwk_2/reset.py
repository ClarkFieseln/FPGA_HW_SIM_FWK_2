...
class Reset:
    ...
    def __init__(self, event):
        ...
        self.__event = event
        self.REPORT_RESET_HIGH = configuration.RESET_INDEX + ":1,"
        self.REPORT_RESET_LOW = configuration.RESET_INDEX + ":0,"
    ...
    def thread_reset(self):
        ...
        while self.__event.evt_close_app.is_set() is False:
            if self.__event.evt_set_reset_high.is_set() is False:
                self.report = self.REPORT_RESET_LOW
                ...
                self.report = self.REPORT_RESET_HIGH
